...
# Define food items and nutritional info : [weight, fat, protien, carb]
food_nutrition = {
...
if use_webcam:
    ...
    with col1:
        st.image(resized_img, caption="Detected Food Items with Calorie Estimation", use_container_width=False)
